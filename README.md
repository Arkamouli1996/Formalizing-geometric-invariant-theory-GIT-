...
The first step is to formalize the definition of a **linearly reductive group**. Once this is done, we should do sanity checks by proving that a finite group is an example. A natural next step would be to prove that GL_n and SL_n are also examples.
